...
import tc.samples.api.util.BaseContainer;
import totalcross.sys.*;
import totalcross.ui.*;
import totalcross.ui.event.*;
import totalcross.ui.gfx.*;

public class RichUserInterfaceSample extends MainWindow {
	static {
		...
		// upload your xap and the page will give you the correct values to put
		// in the properties below
		// These values are placed by tc.Deploy in the file AppxManifest.xml
		// inside the XAP (which is a zip file)
	...
	public RichUserInterfaceSample() {
		super("Rich User Interface", NO_BORDER);
		setTitle("");
